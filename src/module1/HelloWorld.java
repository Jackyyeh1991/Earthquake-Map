...
/** HelloWorld
  ...
  * Date: July 17, 2015
  * */
public class HelloWorld extends PApplet     // Use PAppl
{
...
//		size(800, 600);  // Set up the Applet window to be 800x600
		...
		map1 = new UnfoldingMap(this, 0, 0, 50, 50);
//		map2 = new UnfoldingMap(this, 950, 350, 200, 300);

		// The next line zooms in and centers the map at 
	    // 32.9 (latitude) and -117.2 (longitude)
		map1.zoomAndPanTo(zoomLevel, new Location(32.9f, -117.2f));
//	    map2.zoomAndPanTo(zoomLevel, new Location(29.7143624f, -95.4157554f));
//	    map1.zoomAndPanTo(zoomLevel, new Location(32.9f, -117.2f));
